...
type DemoAnalysis = {
  ...
  platform_recommendations: Record<string, number>;
  summary: string;
  recommendations: string[];
  component_scores: DemoComponentScore[];
  created_at: string;
  updated_at: string;
};
...
const DEMO_ASSETS: DemoAsset[] = [
  {
    ...
    asset_type: "text",
    text_content:
      "🔥 Transform Your Body in Just 12 Weeks! Join 50,000+ busy professionals who achieved their dream physique with FitFlow Pro. Our AI creates personalized workout plans that fit YOUR schedule. No gym required. Start FREE today!",
    file_url: null,
  ...
  },
  {
    ...
    asset_type: "text",
    text_content:
      "No time to workout? 🤔 FitFlow adapts to YOUR schedule. 15-min workouts that actually work. Try it FREE → link in bio",
    file_url: null,
  ...
  },
  {
    ...
    asset_type: "text",
    text_content:
      "Sarah lost 25 lbs in 90 days without giving up her favorite foods. Her secret? FitFlow Pro's AI nutrition coaching. This week only: Get 50% off your first month + FREE meal plans worth $97. Your transformation starts here.",
    file_url: null,
...
const DEMO_ANALYSES: DemoAnalysis[] = [
  {
    ...
    summary:
      "Strong top-of-funnel ad with clear dream outcome and social proof. Emphasizes time efficiency and ease of use.",
    recommendations: [
    ...
    component_scores: [
      {
        ...
        score: 9.0,
        explanation:
          "Clearly states 'Transform Your Body' as the ultimate goal",
        suggestions: null,
      },
      {
        id: "demo-cs-2",
      ...
      },
      {
        ...
        score: 2.0,
        explanation:
          "Implies 'busy' but doesn't explicitly address pain points",
        suggestions:
          "Address frustrations like 'tired of failed diets' or 'no time for gym'",
      },
      {
        id: "demo-cs-7",
        analysis_id: "demo-analysis-1",
  ...
  },
  {
    ...
    summary:
      "Concise story-format ad targeting time-constrained audience. Good for platform but lacks depth.",
    recommendations: [
    ...
    component_scores: [
      {
        ...
        score: 4.0,
        explanation:
          "Implies fitness results but doesn't state transformation clearly",
      ...
      },
      {
        ...
        score: 9.0,
        explanation:
          "Strong emphasis on '15-min workouts' and schedule flexibility",
        suggestions: null,
      },
      {
        id: "demo-cs-10",
  ...
  },
  {
    ...
    summary:
      "Excellent bottom-of-funnel ad with strong proof, specificity, and offer. Well-suited for warmer audiences.",
    recommendations: [
    ...
    component_scores: [
      ...
      },
      {
        ...
        score: 9.0,
        explanation:
          "'without giving up favorite foods' reduces perceived difficulty",
        suggestions: null,
      },
      {
        id: "demo-cs-15",
...
export default function DemoPage() {
  const [selectedBrand] = useState<DemoBrand>(DEMO_BRAND);
  const [assets] = useState<DemoAsset[]>(DEMO_ASSETS);
  const [analyses] = useState<DemoAnalysis[]>(DEMO_ANALYSES);
  const [showAnalysisModal, setShowAnalysisModal] = useState(false);
  const [selectedAnalysis, setSelectedAnalysis] = useState<DemoAnalysis | null>(
    null,
  );
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <p className="text-blue-50 text-lg">
                  {selectedBrand.product_description}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Click any row to view detailed insights
                </p>
              </div>
          ...
          <div className="relative px-6 py-12 sm:px-12">
            ...
            <div className="relative text-center">
              ...
              <p className="text-lg text-blue-50 mb-8 max-w-2xl mx-auto leading-relaxed">
                Get instant AI-powered insights on your ad creatives. Understand
                what&apos;s working, what&apos;s missing, and exactly how to
          ...
          <div className="relative flex items-start justify-between">
            <div className="flex-1 pr-4">
              ...
              <p className="text-blue-100 text-sm">
                Detailed component breakdown and recommendations
              </p>
            </div>
            <button
              onClick={onClose}
